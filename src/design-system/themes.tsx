...
export const ThemeRoot = styled.div`
  ...
  --svgs-types-blog-slider: url("${cndUrl}/assets/images/2b6c7280-2270-43f7-988b-9cc5094d209a.png");
  ...
  --svgs-types-blog-page: url("${cndUrl}/assets/images/71fca2e7-93c0-4334-873d-0a1a98c8baa4.png");
  --svgs-types-info-login: url("${cndUrl}/assets/images/cd88d5cc-c072-4909-bcaf-32f6456c46b3.svg");
  --svgs-types-blog-steveJob: url("${cndUrl}/assets/images/ec59fcad-0aca-4b9a-9000-87d1406f93f7.png");
  --svgs-types-blog-editor: url("${cndUrl}/assets/images/153452d7-b049-495a-bdba-abfea81d42d2.png");
  ...
  --svgs-types-blog-buttons: url("${cndUrl}/assets/images/656c643c-f0ed-4a88-ab47-569c66e79e92.png");
  --svgs-types-screenshot-component: url("${cndUrl}/assets/images/cc7679c7-46d6-4979-a4e1-d52d530b5823.png");
  --svgs-types-team-vishal: url("${cndUrl}/assets/images/35ba40a7-9c4e-41b4-89cd-d3146c5f18ab.png");
  --svgs-types-team-dipak: url("${cndUrl}/assets/images/ddd35e33-1654-4029-8ba9-145d5b058c90.png");
  --svgs-types-team-harsh: url("${cndUrl}/assets/images/2a90f353-cf53-45e3-8efb-565836fc04f8.png");
  ...
  --svgs-types-blog-timeline: url("${cndUrl}/assets/images/478b9293-4f58-4ce8-97b3-84505d87ec07.png");
  ...
  --svgs-types-logo-tutorialPic: url("${cndUrl}/assets/images/ff02d4c5-ce18-44ca-92eb-0f1fa3797fdd.png");
  --svgs-types-blog-designSystem: url("${cndUrl}/assets/images/d4c362d5-73d0-4fd5-b2b9-d892cbeda340.png");
  ...
  --svgs-types-blog-logic: url("${cndUrl}/assets/images/ed3d0238-bcc6-4a8b-a0a4-773d7c6be97d.png");
