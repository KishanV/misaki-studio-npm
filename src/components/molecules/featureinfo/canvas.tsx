            ...
            <div className={` ${id} ${styles["E96"]}`}>
              <div className={` ${id} ${styles["E97"]}`}>
                <div className={` ${id} ${styles["E98"]}`}>
                  <span className={` ${id} ${styles["E99"]}`}>{"Canvas"}</span>
                </div>
                <div className={` ${id} ${styles["E100"]}`}>
                  <span className={` ${id} ${styles["E101"]}`}>
                    {
                      "Canvas is like any other design tool: infinite, pixel-perfect, with smooth scrolling, zooming in, and zooming out."
                    }
                  </span>
                </div>
              </div>
                ...
                <div className={` ${id} ${styles["E102"]}`}>
                  ...
                  <div className={` ${id} ${styles["E105"]}`}>
                    <span className={` ${id} ${styles["E106"]}`}>
                      {
                        "The elegant and advanced element editor allows for easy manipulation of elements on canvas. It comes with flex-box and fully featured properties configuration panels where you can update, edit, and see values of each property."
                      }
                    </span>
                  </div>
                  <div className={` ${id} ${styles["E107"]}`}>
                    <span className={` ${id} ${styles["E108"]}`}>
                      {
                        "It also support wide rang of layout, style and filter properties including background blur."
                      }
                    </span>
                  </div>
                </div>
                ...
                <div className={` ${id} ${styles["E113"]}`}>
                  ...
                  <div className={` ${id} ${styles["E116"]}`}>
                    <span className={` ${id} ${styles["E117"]}`}>
                      {
                        "There are two different types of animations: timeline animation and transition animation."
                      }
                    </span>
                  </div>
                  <div className={` ${id} ${styles["E1088"]}`}>
                    <span className={` ${id} ${styles["E1089"]}`}>
                      {
                        "Timeline animation functions similarly to standard video editing tools, featuring vertical scrolling and property configuration points. It offers advanced capabilities that let you create beautiful, detailed animations to express emotions and information precisely."
                      }
                    </span>
                  </div>
                </div>
